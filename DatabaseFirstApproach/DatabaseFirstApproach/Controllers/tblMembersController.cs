...
namespace DatabaseFirstApproach.Controllers
{
    public class tblMembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MemberID,MemberName,PhoneNumber")] tblMember tblMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberID,MemberName,PhoneNumber")] tblMember tblMember)
        {
            if (ModelState.IsValid)
            {
