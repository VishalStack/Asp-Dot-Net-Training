...
namespace ModelFirstApproach.Controllers
{
    public class MarksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Subject,FMark,OMark,StudentId")] Mark mark)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Subject,FMark,OMark,StudentId")] Mark mark)
        {
            if (ModelState.IsValid)
            {
