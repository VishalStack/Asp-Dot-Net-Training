...
using JsonMenuBarDBApp.Models;
using System;
using System.Collections.Generic;
using System.Data;
using System.Web.Mvc;

namespace JsonMenuBarDBApp.Controllers
{
    public class HomeController : Controller
    {
        // GET: /Home/
        JsonMenuBarDBApp.database_access_layer.db dblayer = new JsonMenuBarDBApp.database_access_layer.db();
