...
namespace WebApiCRUD_8march_.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="MemberDB")]
    ...
    partial void DeletetblMember(tblMember instance);
		...
		public MemberDataClassesDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["MemberDBConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
